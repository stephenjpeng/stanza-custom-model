...
model="synth_combined_vanilla_from_bert_attn_l_gelu"
output="output_attn_l_gelu"
...
# model="synth_combined_vanilla_attn_10"
# output="output_attn_10"
# echo "Evaluating $model on $file... Output will be written to $output"
# sudo -u mitty PYTHONPATH=$PYTHONPATH:. /opt/conda/envs/pytorch/bin/python3 stanza/models/mitty_experiment/ner_tagger_mitty.py \
# 	--data_dir ./data \
# 	--eval_file  "$file" \
...
# model="synth_combined_vanilla_attn_20"
# output="output_attn_20"
# echo "Evaluating $model on $file... Output will be written to $output"
# sudo -u mitty PYTHONPATH=$PYTHONPATH:. /opt/conda/envs/pytorch/bin/python3 stanza/models/mitty_experiment/ner_tagger_mitty.py \
# 	--data_dir ./data \
# 	--eval_file  "$file" \

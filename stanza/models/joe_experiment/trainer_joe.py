...
from stanza.models.joe_experiment.model_w_Conv import NERTagger_wConv # Updated to pull model with Conv layer
from stanza.models.data_extractor.vocab import MultiVocab      # Updated to pull correct vocab from Stephen's vocab.py file
...
class Trainer(BaseTrainer):
    ...
    def __init__(self, args=None, vocab=None, pretrain=None, model_file=None, use_cuda=False,
        ...
        if model_file is not None:
            ...
            self.model = NERTagger_wConv(args, vocab, emb_matrix=pretrain.emb, bert_model = self.bert_model, bert_tokenizer = self.bert_tokenizer, use_cuda = self.use_cuda)
    ...
    def load(self, filename, pretrain=None, args=None, foundation_cache=None):
        ...
        self.model = NERTagger_wConv(self.args, self.vocab, emb_matrix=emb_matrix, bert_model=self.bert_model, bert_tokenizer=self.bert_tokenizer, use_cuda=self.use_cuda)

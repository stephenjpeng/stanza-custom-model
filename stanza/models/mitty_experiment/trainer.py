...
from stanza.models.mitty_experiment.model import model_w_Ablation
...
class Trainer(BaseTrainer):
    ...
    def load(self, filename, pretrain=None, args=None, foundation_cache=None):
        ...
        self.model = model_w_Ablation(self.args, self.vocab, emb_matrix=emb_matrix, bert_model=self.bert_model, bert_tokenizer=self.bert_tokenizer, use_cuda=self.use_cuda)
